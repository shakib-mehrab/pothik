      ...
      <div className="px-6 py-16">
        <Card className="p-8 text-center">
          ...
          <p className="text-muted-foreground text-sm mb-4">
            We're working on bringing you comprehensive inter-district bus information
          </p>
        ...
        <div className="mt-8 space-y-3">
          ...
          {[
            "Long-distance bus routes between cities",
            "Bus company information and contacts",
            "Fare and schedule information",
            "Counter locations and booking details"
          ].map((feature, idx) => (
